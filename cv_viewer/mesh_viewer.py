...
class GLViewer:
    ...
    def init(self, _params, _has_imu): 
        ...
        self.glWindow = glutCreateWindow("ZED Plane Detection")
        glutHideWindow()
    ...
    def draw(self):  
        ...
        if self.available:
            ...
            data = glReadPixels(0, 0, self.wnd_w, self.wnd_h, GL_BGRA, GL_UNSIGNED_BYTE)
            image = Image.frombytes("RGBA", (self.wnd_w, self.wnd_h), data)
